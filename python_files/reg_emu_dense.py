...
## This needs some major work, I don't understand dense nets!!!!
class _DenseBlock(nn.Sequential):
	def __init__(self,num_input_feats, gr, bn_size, drop):
		super(_DenseBlock, self).__init__()
		self.add_module('norm1', nn.BatchNorm3d(num_input_feats))
		self.addmodule('relu1'
...
class Net(nn.Module):
	def __init__(self, dims):
		...
		func = F.relu ##activation function
